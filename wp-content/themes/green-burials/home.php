 ...
 * Description: Blog listing page for posts (used when a static page is set as "Posts page")
 */
    ...
    <div class="container">
        ...
        <div class="blog-grid-section">
            ...
            <div class="load-more-container" style="text-align: center; margin-top: 40px;">
                ...
                <div class="loading-spinner-container" style="display:none; justify-content: center; align-items: center; gap: 10px; margin-top: 10px;">
