...
if ( class_exists( 'WC_Settings_Page' ) ) {
	...
	class THEMECOMPLETE_EPO_ADMIN_SETTINGS extends WC_Settings_Page {
		...
		public function tm_tabs_header_setting() {
			...
			echo '</div>';
			echo '<div class="header tm-gridrow">';
			echo '<div class="tm-search-container"><input type="text" id="tm-settings-search" placeholder="' . esc_html__( 'Search settings...', 'woocommerce-tm-extra-product-options' ) . '" autocomplete="off"><div id="tm-search-results" class="tm-search-results"></div></div>';
