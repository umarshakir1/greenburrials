...
final class THEMECOMPLETE_EPO_SETTINGS_Base {
	...
	public function get_setting_string( $setting, $label ) {
		return [
			...
			[
				'title'       => esc_html__( 'Choice button selector text', 'woocommerce-tm-extra-product-options' ),
				'desc'        => esc_html__( 'Enter a text to replace the button selector text button for image and color swatches.', 'woocommerce-tm-extra-product-options' ),
				'id'          => 'tm_epo_cbsmel_button_text',
				'placeholder' => esc_html__( 'Select choice', 'woocommerce-tm-extra-product-options' ),
				'default'     => '',
				'class'       => 'tcselements',
				'type'        => 'text',
			],
		...
		return [
			...
			[
				...
				'options' => [
					...
					'browser' => esc_html__( 'Determine by browser locale', 'woocommerce-tm-extra-product-options' ),
			...
			[
				'title'       => esc_html__( 'Main Product Price Selector (CSS)', 'woocommerce-tm-extra-product-options' ),
				'desc'        => esc_html__( 'Specify the CSS selector that identifies the main product’s price element. Related or secondary product templates should not share this selector.', 'woocommerce-tm-extra-product-options' ),
				'placeholder' => '.woocommerce .product p.price, .wc-block-components-product-price',
				'id'          => 'tm_epo_global_product_price_selector',
				'default'     => '',
				'class'       => 'tcglobal3',
				'type'        => 'text',
			],
		...
		return [
			[
				...
				'desc'  => '<span tabindex="0" data-menu="tcelements1" class="tm-section-menu-item">' . esc_html__( 'General', 'woocommerce-tm-extra-product-options' ) . '</span>' .
						...
						'<span tabindex="0" data-menu="tcelements9" class="tm-section-menu-item">' . esc_html__( 'Checkboxes', 'woocommerce-tm-extra-product-options' ) . '</span>' .
			...
			[
				'title'   => esc_html__( 'Show disabled choices for radio buttons', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'When enabled, this option displays disabled radio button choices (grayed out) in the product options list, allowing customers to see unavailable choices while preventing selection.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_global_show_radiobuttons_disabled_choice',
				'default' => 'no',
				'class'   => 'tcelements2',
				'type'    => 'checkbox',
			],
			[
				'title'   => esc_html__( 'Show disabled choices for checkboxes', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'When enabled, this option displays disabled checkbox choices (grayed out) in the product options list, allowing customers to see unavailable choices while preventing selection.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_global_show_checkboxes_disabled_choice',
				'default' => 'no',
				'class'   => 'tcelements9',
				'type'    => 'checkbox',
			],
			...
			[
				'title'   => esc_html__( 'Convert cart and order dates to site’s date format', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'When enabled, all dates displayed in the shopping cart, checkout, and order details will be reformatted to match the date format you’ve chosen in WordPress settings.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_posted_dates_wp_format',
				'default' => 'no',
				'class'   => 'tcelements3',
				'type'    => 'checkbox',
			],
