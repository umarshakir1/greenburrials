 ...
 * @version 7.0
 */
class THEMECOMPLETE_EPO_BUILDER_ELEMENT_FAKE_PRODUCT extends THEMECOMPLETE_EPO_BUILDER_ELEMENT {
	...
	public function __construct( $name = '' ) {
		...
		$this->name             = esc_html__( 'Fake Product', 'woocommerce-tm-extra-product-options' );
		$this->description      = '';
		$this->width            = 'w100';
		...
		$this->is_post          = 'post';
		$this->type             = 'single';
		$this->post_name_prefix = 'fake_product';
		$this->fee_type         = '';
		$this->tags             = '';
