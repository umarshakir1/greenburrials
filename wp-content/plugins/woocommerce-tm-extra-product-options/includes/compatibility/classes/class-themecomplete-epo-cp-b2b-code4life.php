...
final class THEMECOMPLETE_EPO_CP_B2B_Code4Life {
	...
	public function add_compatibility() {
		...
		add_filter( 'woocommerce_product_get_price', [ $this, 'change_price' ], PHP_INT_MAX, 2 );
	}
	...
	public function wc_epo_add_cart_item_original_price( $price, $cart_item ) {
		// Returns the already-cached price that WooCommerce uses for display and calculations.
	...
	public function change_price( $price, $product ) {
		if ( $product instanceof WC_Product && $product->get_meta( 'epo_price', true ) !== '' ) {
